...
const RubiksCubeGame: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (!root || root.dataset.rubiksInitialized === 'true') return;

        root.dataset.rubiksInitialized = 'true';
        bootRubiksCubeGame(root, THREE);
    }, []);

    return (
        <div className="rubiks-game min-h-screen flex items-center justify-center bg-black text-white" ref={rootRef}>
            <div className="ui relative w-full max-w-5xl">
                ...
                <div className="ui__stats mt-6 space-y-2">
...
function bootRubiksCubeGame(root: HTMLElement, THREE_NS: typeof THREE) {
